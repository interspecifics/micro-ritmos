"""
light_clusters
detect light position, create vectors of notes
collect samples to selftrain periodically
learn clusters of patterns from samples
recognize cluster for sample on the fly
"""
